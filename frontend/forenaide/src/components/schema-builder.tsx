  ...
  return (
    <div className="">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <SaveTemplateDialog>
                  <Button className="my-auto" disabled={config.length === 0}>
                    Save Template
                    <Save />
                  </Button>
                </SaveTemplateDialog>
      ...
      <div className="flex flex-row mt-4">
        <Button onClick={handleAddField} className="my-auto text-sm h-8">
          <Plus /> Add New Field
        </Button>
        <Separator className="my-4" orientation="vertical" />
        <SchemaOptionDropdown>
          <Button className="ml-1 my-auto h-8" variant={"secondary"}>
            Schema Options <Cog />
          </Button>
        </SchemaOptionDropdown>
      </div>
